...
const Card = ({
  ...
  return (
    <div className="max-w-sm rounded-2xl overflow-hidden shadow-lg bg-white my-10 mx-8 transform hover:scale-105 transition-transform duration-300">
      <img
      ...
      <div className="px-6 pt-4 pb-4 flex items-center flex-wrap">
